...
public class Vcode extends ActionSupport{
	...
	static{
		...
		String strWidth = sc.getInitParameter("width");
		// 高度
		String strHeight = sc.getInitParameter("height");
		// 字符个数
		String strCodeCount = sc.getInitParameter("codeCount");
	...
	public String vCode() throws Exception{
...
//				req.setAttribute("validateCode", vcodeBuff.toString());
				//打印生成的验证码
				System.out.println("当前session对象："+vcodeBuff.toString());
